...
export const CargueRegionalItem = ({ operativo }: CargueNacionalItemProps) => {
    ...
    return (
        <>
            ...
            <CargueDespachoModal operativoId={operativo.id} setShowForm={setShowForm} showForm={showForm} operativo={operativo.operativo} />
        </>
    )
}
