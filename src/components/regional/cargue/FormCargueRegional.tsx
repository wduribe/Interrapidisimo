...
import { regionalSelect } from '../../../interfaces/interfaces';
...
export const FormCargueRegional = () => {
    ...
    return (
        <form
            ...
            <h3 className="mt-4 mb-2 font-bold text-2xl max-[460px]:text-center">Formulario de Cargue Operativos Regionales</h3>
            <label className="mb-2">
                <p className="mb-1">Eligir Operativo Regional</p>
                <select
            ...
            <div className="my-2 flex gap-2">
                <div className="flex flex-col">
                    ...
                    <label><input onChange={handleChange} type="radio" name="tipoOperativo" defaultChecked defaultValue={'pueblos'} />{"  "} Pueblos</label>
                </div>
