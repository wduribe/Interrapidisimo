...
import { nacionalSelect, type IngresoOperativoDescargueForm } from '../../../interfaces/interfaces';
...
export const FormDescargueNacional = () => {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    dispatch({
      type: 'ingreso-nacional-descargue',
      payload: {
        descargueNacional: form,
      }
    });
  ...
  return (
    <form
      ...
      <h3 className="mt-4 mb-2 font-bold text-2xl max-[460px]:text-center">Formulario de Descargue Operativos Nacionales</h3>
      <label className="mb-2" htmlFor="zona">
        Eligir Operativo Nacional
        <select
      ...
      <div className="mb-2 flex gap-2">
        ...
        <div className="flex flex-col justify-end">
          ...
          <label><input onChange={handleChange} defaultChecked defaultValue={'nacional'} type="radio" name="tipoOperativo" />{"  "} Nacional</label>
        </div>
      </div>
